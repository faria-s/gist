defmodule SalGist.CommentsTest do
  use SalGist.DataCase

  alias SalGist.Comments

  describe "coments" do
    alias SalGist.Comments.Comment

    import SalGist.CommentsFixtures

    @invalid_attrs %{markup_text: nil}

    test "list_coments/0 returns all coments" do
      comment = comment_fixture()
      assert Comments.list_coments() == [comment]
    end
